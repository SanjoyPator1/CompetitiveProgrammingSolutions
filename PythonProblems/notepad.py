...
class Notepad:
    ...
    # Set window size as mentioned above (the default is 300x300)
        ...
        self.__thisCommandMenu.add_command(
            label="About Commands", command=self.__showCommand)
        self.__thisMenuBar.add_cascade(
            label="Commands", menu=self.__thisCommandMenu)
